...
from utils.img_process import get_contour, get_target_true_area,contours_process
# 调试板初始化
def palette_init():
...
def parse_args():
    ...
    # 主要
    parser.add_argument("--weights_path", default=r'logs/05-08_16-24-18-X_unet_fin_all8/best_model.pth', type=str, help="权重路径")
