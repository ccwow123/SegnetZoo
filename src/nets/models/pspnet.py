...
def get_psp(num_class=1, backbone='resnet101', pretrained=False, root='~/.torch/models',
    ...
    Examples
    --------
    >>> model = get_psp(dataset=num_class, backbone=backbone, pretrained=pretrained)
    >>> print(model)
    """

    model = PSPNet(num_class, backbone=backbone, pretrained_base=pretrained, **kwargs)
