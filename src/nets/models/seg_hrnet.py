...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, in_channel=1, num_class=1, **kwargs):
        ...
        STAGE4['NUM_CHANNELS'] = [48, 96, 192, 384]
        STAGE4['BLOCK'] = 'BASIC'
...
# model = HighResolutionNet(1,1)
# device = 'cuda'
# model.to(device)
# x = torch.rand([1,1,560,560]).to(device)
# with torch.no_grad():
#     print(model(x).shape)